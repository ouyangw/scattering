...
#ifndef TULLY_1_WRONG2_HPP
#define TULLY_1_WRONG2_HPP
#include "scattering_1d.hpp"
#include <cmath>
namespace scattering_1d
{
class Tully_1_Wrong2 : public ElectronicHamiltonianBuilder
{
public:
  Tully_1_Wrong2(double A, double B, double C, double D)
      : m_A(A)
      , m_B(B)
      , m_C(C)
      , m_D(D)
  ...
  void build_H(std::vector<MatrixElement> &H_uptri, double x)
  {
    ...
    H_uptri.push_back(MatrixElement(2, 1, m_C * std::exp(-m_D * x * x)));
  }
